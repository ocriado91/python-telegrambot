...
class TelegramBot:
    ...
    def send_photo(self,
        ...
        logger.info('Sending photo %s to %s using %s',
                    file_id,
                    self.chat_id,
                    url)
        # Post request
    ...
    def send_audio(self,
        ...
        logger.info('Sending audio %s to %s using %s',
                    file_id,
                    self.chat_id,
                    url)
        # Post request
    ...
    def send_video(self,
        ...
        logger.info('Sending video %s to %s using %s',
                    file_id,
                    self.chat_id,
                    url)
        # Post request
    ...
    def _download_file(self,
                       file_id: str,
                       download_path: str = 'download/') -> bool:
        '''
        ...
        logger.info('Trying to download %s (%s)',
                    file_id,
                    url)
